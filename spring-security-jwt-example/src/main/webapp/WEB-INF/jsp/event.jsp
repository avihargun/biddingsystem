        ...
        <div class="row">
          ...
          <div class="col-xs-10 col-sm-3">
            ...
            <div style="  text-align: right;">
              <b>Seller name</b>: ${items.sellerId}
            </div>
            ...
            <div class="tab-content">
                ...
                <div class="container">
                  <c:forEach var="c" items="${catalog}">
                    <div class="card">
                        <img src="https://codingyaar.com/wp-content/uploads/bootstrap-4-card-image-left-demo-image.jpg" style=" border: 5px solid #555; " class="card-img-top" />
                        <div class="card-body">
